   	...
   	<div id="board_box">
	    ...
	    <ul id="board_list">
				<li>
					...
					<span class="col2" style="width: 320px;">제목</span>
					<span class="col3">채택여부</span>
					<span class="col5">작성일</span>
          <span class="col5">수정일</span>
          <span class="col3">작성자</span>
          <span class="col4">익명</span>
				</li>
<?php
  if (isset($_GET["page"]))
    $page = $_GET["page"];
	...
	$sql = "select * from answer where user_id = $user_id and is_deleted = 0 order by id desc";
...
?>
				<li>
					...
					<span class="col2" style="width: 320px;"><a href="../board/board_view.php?id=<?=$board_id?>&page=<?=$page?>"><?=$title?></a></span>
          <?php
          if($is_selected) echo "<span class='col3'> O </span>";
          else echo "<span class='col3'> X </span>";
          ?>
